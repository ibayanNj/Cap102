...
class RatingScaleCard extends StatelessWidget {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            _buildRatingScaleItem(5, 'Outstanding', Colors.green),
            _buildRatingScaleItem(4, 'Very Satisfactory', Colors.lightGreen),
            _buildRatingScaleItem(3, 'Satisfactory', Colors.yellow[700]!),
            _buildRatingScaleItem(2, 'Fair', Colors.orange),
            _buildRatingScaleItem(1, 'Poor', Colors.red),
          ],
        ),
      ),
    );
  ...
  Widget _buildRatingScaleItem(int stars, String label, Color color) {
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 4.0),
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.center,
